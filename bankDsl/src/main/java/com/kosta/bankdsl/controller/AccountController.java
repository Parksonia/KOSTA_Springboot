package com.kosta.bankdsl.controller;
...
import com.kosta.bankdsl.service.AccountService;
...
public class AccountController {
	...
	public ModelAndView makeAccount(AccountDto acc) {
		ModelAndView mav = new ModelAndView();
		try {
			AccountDto sacc = accountService.makeAccount(acc);
	...
	public ModelAndView deposit(@RequestParam("id") String id, @RequestParam("money") Integer money) {
		ModelAndView mav = new ModelAndView();
		try {
			AccountDto acc = accountService.deposit(id, money);
	...
	public String withdraw(HttpServletRequest request, Model model) {
		try {
			...
			AccountDto acc = accountService.withdraw(id, money);
			model.addAttribute("acc", acc);
			return "accountinfo";
		} catch (Exception e) {
	...
	public ModelAndView allAccountinfo() {
		ModelAndView mav = new ModelAndView();
		try {
			List<AccountDto> accs = accountService.allacountinfo();
